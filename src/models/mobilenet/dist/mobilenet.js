...
//     (factory((global.mobilenet = {}),global.tf));
// }(this, (function (exports,tf) { 
    ...
    ***************************************************************************** */
    ...
    function load(version, alpha) {
        console.log("so I AM in the mobilenet function (0)");
        if (version === void 0) { version = 1; }
        if (alpha === void 0) { alpha = 1.0; }
        return __awaiter(this, void 0, void 0, function () {
            var mobilenet;
            console.log("so I AM in the mobilenet function");
    ...
    var MobileNet = (function () {
        ...
        MobileNet.prototype.load_old = function () {
            return __awaiter(this, void 0, void 0, function () {
        ...
        MobileNet.prototype.getLastWeights = function () {
            // return tf.squeeze(this.variables['MobilenetV1/Conv2d_13_pointwise/weights']);
    ...
    function CAM(softmaxWeights, lastActivation, classX) {
        var softMaxW = tf.transpose(softmaxWeights).gather(tf.tensor1d([classX]));
        var lastAct = tf.transpose(lastActivation.reshape([49, 1024]));
        var cam = tf.matMul(softMaxW, lastAct);
        cam = cam.reshape([7, 7]);
